  ...
  useEffect(() => {
    fetch(
      ...
      .then(async (value) => {
        ...
        console.log(named_rosters.find(({ owner_id }) => owner_id == player));
        setRosters(named_rosters.find(({ owner_id }) => owner_id == player));
      });
  }, []);
        ...
        {rosters["owner_id"] != undefined ? (
          <>
            <div className={styles.item}>
              ...
              <p className={styles.itemRank}>{rosters["starter_value_rank"]}</p>
            </div>
            <div className={styles.item}>
