...
# Load the CSV files
cleaned_adjusted_players_df = pd.read_csv('cleaned_adjusted_players.csv')
...
cleaned_adjusted_players_df['cleaned_name'] = cleaned_adjusted_players_df['Name']
...
merged_df.drop(["birth_city", "Unnamed: 0", "Name_y", "position"], axis=1, inplace=True)
